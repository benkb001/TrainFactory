...
public class DrawTravelingInterfaceSystem {
    public static void Register(World w) {
        w.AddSystem([typeof(DrawTravelingInterfaceMessage)], (w, e) => {
            ...
            int containerEnt = EntityFactory.Add(w, scene: maxScene); 
            ...
            int summaryEnt = EntityFactory.Add(w, scene: maxScene); 
            ...
            int timeEnt = EntityFactory.Add(w, scene: maxScene); 
            ...
            int invEnt = EntityFactory.Add(w, scene: maxScene); 
